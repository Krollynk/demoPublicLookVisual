<div class="grid_box main_content">
    <h2 class="main_title_form">Cliente Nuevo</h2>
    <form action="/guardar_cliente" class="main_form" id="main_form" method="post">
        <input type="hidden" class="modulo" name="modulo" value="clienteUpdate">
        <input type="hidden" class="clienteId" name="clienteId">
